...
class App(tk.Tk):
    def __init__(self):
        ...
        left_label = tk.Label(bottom, text='Velocidad (m/s)', font=("Helvetica", 16), bg='#c9d3db')
        right_label = tk.Label(bottom, text='Temperatura (F)', font=("Helvetica", 16), bg='#c9d3db', padx=3, pady=3)
